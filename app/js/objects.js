    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                name: "Art",
                icon: "fas fa-brush",
                intro: ["In most things I do I find a way to incorporate creativity. But sometimes there is drawing just for the sake of it.", "Scroll down to find some things I made."],
                info: [
                    {
            ...
            },
            {
                ...
                info: [
                    ...
                    },
                    {
                        ...
                        embed: '<iframe width="560" height="315" src="https://www.youtube.com/embed/ekF7mymVYGk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                    },
                    {
                        title: "Star Horse - 100 Eyes",
                        text: [""],
                        embed: '<iframe width="560" height="315" src="https://www.youtube.com/embed/nk2ZH_EGZd8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                    },
                    {
                        title: "Star Horse - Slower Now",
                        text: ["Music video recorded in a quarry in Skövde."],
                        embed: '<iframe width="560" height="315" src="https://www.youtube.com/embed/XN8UkYnsvn0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                    },
                ]
            }
        ]
